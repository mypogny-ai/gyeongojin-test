...
const entitlementCategories = buildCategories([
  ...
  },
  {
    ...
    questions: [
      '나는 사랑을 쉽게 수용하지 못합니다.',
      '나는 상대에게 사랑을 증명하라고 요구합니다.',
      '나는 가르침을 선택적으로 받아들입니다.',
      '나는 조언을 무시합니다.',
      '나는 듣기 싫은 부분을 걸러냅니다.',
      '나는 특정 영역을 차단합니다.',
      '나는 조언을 듣고도 실행하지 않습니다.',
      '나는 특정 사람 말만 듣습니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    name: '통제 심리',
    questions: [
      '나는 항상 바쁘고 시간 부족을 느낍니다.',
      '나는 늘 불안합니다.',
      '나는 완벽한 계획을 세우려 합니다.',
      '나는 하나님의 방식보다 내 방식을 신뢰합니다.',
      '나는 모든 것을 세세히 관리하려 합니다.',
      '계획이 틀어지면 화가 납니다.',
    ],
  },
  {
    ...
    name: '포기 심리',
    questions: [
      '인정을 못 받으면 쉽게 손을 놓습니다.',
      '시간과 노력이 필요한 일을 회피합니다.',
      '힘든 결정이 필요하면 도망갑니다.',
      '관계나 일이 순조롭지 않으면 빨리 포기합니다.',
      '새로운 시도를 금방 포기합니다.',
      '이용당한다고 느끼면 관계를 끊습니다.',
      '나중에 한다고 미루며 포기합니다.',
      '조언을 받으면 방어적으로 거부합니다.',
  ...
  },
  {
    ...
    questions: [
      ...
      '나는 섬김을 선택할 권리가 있다.',
      '나는 보복할 권리가 있다.',
      '나는 원하는 방식으로 사랑받을 권리가 있다.',
      '나는 인정받을 권리가 있다.',
      '나는 희생에 대한 보상을 받을 권리가 있다.',
      '나는 내 의견이 존중받을 권리가 있다.',
      '나는 하고 싶은 일을 할 권리가 있다.',
      '나는 실패를 용서받을 권리가 있다.',
      '나는 내 시간표대로 변화될 권리가 있다.',
      '나는 스스로 보상할 권리가 있다.',
      '나는 불평할 권리가 있다.',
      '나는 재정적 안락을 누릴 권리가 있다.',
      '나는 불편하면 물러날 권리가 있다.',
      '나는 재정을 내 뜻대로 쓸 권리가 있다.',
      '나는 내 시간을 마음대로 쓸 권리가 있다.',
      '나는 혼자 있을 권리가 있다.',
      '나는 격려받을 권리가 있다.',
      '나는 통제력을 유지할 권리가 있다.',
      '나는 재산을 독점할 권리가 있다.',
      ...
      '나는 모두에게 사랑받을 권리가 있다.',
      '나는 간섭받지 않을 권리가 있다.',
      '나는 특별 상황에서 죄를 정당화할 권리가 있다.',
      '나는 내 방식대로 사람을 바꿀 권리가 있다.',
      '나는 독립적으로 살 권리가 있다.',
      '나는 내 마음대로 결정할 권리가 있다.',
      '나는 옛 습관으로 돌아갈 권리가 있다.',
    ],
  },
]);
